...
#define LI_BIT 9   // src-BF, dst-BF 비트 (individual)   // 50개의 요소를 오류율 0.01로 프로그래밍하기 위해서 약 479비트 크기의 필터 크기가 필요 -> 필터 크기를 512로 설정
#define LT_BIT 10  // tuple-BF 비트
#define LH_BIT 9   // hash table 비트
...
#define RESULT_LOCATION "./result.txt"            // 결과 파일 경로
